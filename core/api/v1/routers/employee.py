...
router = fastapi.APIRouter(prefix="/emp", tags=["employee"])
...
async def get_employee_main_info(request: Request, response: Response):
    ...


@router.get("/full-info", response_class=HTMLResponse)
async def get_employee_full_info(request: Request, response: Response):
    ...


@router.get("/offers", response_class=HTMLResponse)
async def get_employee_active_offers(request: Request, response: Response):
    ...


@router.get("/history", response_class=HTMLResponse)
async def get_employee_previous_works(request: Request, response: Response):
    ...
...
async def patch_employee(request: Request, response: Response):
    ...


# @router.delete("/", response_class=HTMLResponse)
# async def delete_employee(request: Request, response: Response):
#     ...
